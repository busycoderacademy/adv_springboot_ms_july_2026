...
public class AccountCrudController {
    ...
    private BankDtoConfig bankDtoConfig;

    @Autowired
    public void setAccountService(AccountService accountService, BankDtoConfig bankDtoConfig) {
        this.accountService = accountService;
        this.bankDtoConfig = bankDtoConfig;
    }
...
//        }
    ...
    public ResponseEntity<String> create( @Valid  @RequestBody Account account) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body("account is created sucessfully "+ account.getId());
    }
    //delete account
    ...
    //i want to read this in bankDtoConfig
    @GetMapping("/bankinfo")
    public ResponseEntity<BankDtoConfig> getBank() {
        return ResponseEntity.ok(bankDtoConfig);
    }
